...
class PeriodicCheckpoint(pl.callbacks.ModelCheckpoint):
    def __init__(self, every: int, monitor="", checkpoint_dir=""):
        super().__init__(
            period=-1,monitor=monitor, mode="max", save_top_k=1, save_last=True,
    ...
    def on_train_batch_end(
        ...
        if pl_module.global_step != self.last_step and pl_module.global_step % self.every == 0:
            ...
            print("save checkpoint!", pl_module.global_step)
...
def main():
    ...
    #     dirpath=checkpoint_dir, save_step_frequency=100)
