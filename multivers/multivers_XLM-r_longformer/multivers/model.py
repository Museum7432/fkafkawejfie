...
from transformers import LongformerModel, XLMRobertaModel
...
def get_XLMR_longformer():
    if not os.path.isdir("checkpoints/XLMR_4096"):
        os.makedirs(os.path.dirname("./checkpoints"), exist_ok=True)
        model = XLMRobertaLongModel.from_pretrained("markussagen/xlm-roberta-longformer-base-4096")
        model.save_pretrained("checkpoints/XLMR_4096")
...
class MultiVerSModel(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--encoder_name", type=str, default="markussagen/xlm-roberta-longformer-base-4096")
    ...
    def _get_encoder(hparams):
        ...
        starting_encoder_name = "markussagen/xlm-roberta-longformer-base-4096"
        # encoder = XLMRobertaLongModel.from_pretrained(
        ...
        encoder = LongformerModel.from_pretrained("checkpoints/XLMR_4096")
